from .postrequests import get_all_posts, get_single_post, create_post, update_post, delete_post, get_all_users_posts
...
from .tagrequests import get_all_tags, get_single_tag, create_tag, update_tag, delete_tag, get_single_post_tag, get_all_post_tags,create_post_tag
